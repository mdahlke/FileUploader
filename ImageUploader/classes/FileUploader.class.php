...
/**
 * FileUploader is a class that allows for easy implementation for uploading
 * multiple image or audio files at once.
...
class FileUploader {
	...
	protected $fileType							= array();	// This is not the subtype of the file (.mp3 or .jpg) this will be either (audio or image)
	
	protected $fileTypeForUpload; // this will be set by the child classes to their respective file type (i.e. 'image' or 'audio')
	// Read only variables
